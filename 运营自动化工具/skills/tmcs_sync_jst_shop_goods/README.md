...
- 猫超平台查询在 Ops-Cli：`ops tmcs stock query ...`
- 聚水潭双浏览器学习和页面导入在 Ops-Cli：`ops jst browser learn ...`、`ops jst shop-goods import ...`
...
```bash
ops tmcs stock query --item-ids 123456,234567 --warehouse-code mc_aokesi_suolong --output json
