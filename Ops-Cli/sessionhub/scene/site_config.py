    ...
    data: dict[str, Any] = {
        ...
        "scenes": {
            ...
            "tmcs_promotion_wxt_bill_export": {
                "target_url": "https://one.alimama.com/index.html#!/account/detail",
                "match_url_contains": ["exportAccountJournal"],
                "method": "POST",
                "auto_actions": [
                    {"type": "goto_target"},
                    {"type": "click_any_text", "texts": ["下载数据", "导出", "导出列表", "下载"]},
                ],
                "wait_seconds": 150,
                "capture_retry_limit": 40,
                "action_interval_seconds": 3,
                "click_wait_ms": 2500,
                "cache_minutes": 30,
                "force_refresh_before_run": True,
                "manual_login_when_failed": True,
